...
//минута 44; минута 17; 53 секунды
    ...
    public void checkHeaderElementsTest() {
        ...
        viewportPage.siteHeader.pricingDropDown.elementExist();
    }
    ...
    public void checkElementsInWhyDropDownTest() {
        ...
        viewportPage.siteHeader.whyDropDown.checkExist("Customer stories");
    }
    ...
    public void checkCountInWhyDropDownTest() {
        viewportPage.siteHeader.whyDropDown.checkCount(11);
    }
    ...
    public void checkAbsentElementInWhyDropDownTest() {
        ...
        viewportPage.siteHeader.whyDropDown.checkAbsent("sdddawdawd");
    }
}
